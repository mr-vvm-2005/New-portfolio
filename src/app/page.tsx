                    ...
                    <nav className="flex flex-wrap justify-center gap-4 md:gap-8">
                        {[
                            ...
                            <a
                                key={label}
                                href={href}
                                className="text-white/30 hover:text-white transition-colors text-xs uppercase tracking-widest"
                            >
                                {label}
                            </a>
                        ))}
                        <a
                            href="https://github.com/mr-vvm-2005"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-white/30 hover:text-accent-blue transition-colors text-xs uppercase tracking-widest"
                        >
                            GitHub
                        </a>
                        <a
                            href="https://www.linkedin.com/in/mrvvmoffical2005"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-white/30 hover:text-accent-violet transition-colors text-xs uppercase tracking-widest"
                        >
                            LinkedIn
                        </a>
                    </nav>
