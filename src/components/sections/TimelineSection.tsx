...
const timelineData: TimelineItem[] = [
    ...
    },
    {
        id: "exp-2",
        type: "Experience",
        title: "Virtual Web & Data Engineering Intern",
        subtitle: "Adroit Technologies Innovative Solutions Pvt Ltd",
        location: "Remote",
        date: "Mar 2026 – Apr 2026",
        details: "Completed a virtual internship focused on web data visualisations and analytics pipelines. Built interactive dashboards, created data integration reports, and analyzed real-world business datasets.",
        icon: <Briefcase size={18} />,
    ...
    },
    {
        ...
        details: "Successfully completed a 1-month Full Stack Development internship. Built responsive web interfaces and web application dashboards using React.js and REST APIs, working with real-world datasets.",
        icon: <Briefcase size={18} />,
        badge: "Internship Certificate",
        completed: true,
    },
