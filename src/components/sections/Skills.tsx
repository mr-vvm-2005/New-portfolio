...
const skills = [
    ...
    { name: "ReactJS",              emoji: "⚛️", category: "Frontend",    level: 80, color: "#61DAFB" },
    { name: "Next.js",              emoji: "▲",  category: "Frontend",    level: 75, color: "#ffffff" },
    { name: "Tailwind CSS",         emoji: "💨", category: "Frontend",    level: 90, color: "#06B6D4" },
    { name: "Python",               emoji: "🐍", category: "Backend",     level: 80, color: "#3776AB" },
    { name: "SQL",                  emoji: "🗄️", category: "Backend",     level: 75, color: "#4479A1" },
    { name: "Node.js",              emoji: "🟢", category: "Backend",     level: 70, color: "#339933" },
